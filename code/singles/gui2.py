...
from PyQt5.QtWidgets import QApplication, QPushButton, QLabel, QWidget, QGridLayout
...
class CameraViewer(QWidget):
    def __init__(self, ros_node):
        ...
        self.toggle_button = QPushButton("Switch Mode")
        ...
        layout.addWidget(self.toggle_button, 0, 3)
        self.setLayout(layout)

        self.process_in_grayscale = False
    ...
    def toggle_grayscale(self):
        self.process_in_grayscale = self.toggle_button.isChecked()
